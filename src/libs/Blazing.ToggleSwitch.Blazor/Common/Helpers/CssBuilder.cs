...
#pragma warning disable CA1066 // Type should implement IEquatable<T>

namespace Blazing.Common;

/// <summary>
/// A utility struct for building conditional CSS class strings.
/// </summary>
public struct CssBuilder
{
    ...
    /// </summary>
    /// <param name="value">The raw string value to add.</param>
    /// <returns>CssBuilder</returns>
	...
	public CssBuilder AddClass(Func<string> value, bool when = true)
		=> when ? AddClass(value?.Invoke() ?? string.Empty) : this;
	...
	/// </summary>
	/// <returns>The completed CSS class string.</returns>
    public string Build()
