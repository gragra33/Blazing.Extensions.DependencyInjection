...
/// <summary>
/// Represents the input logic and state for a toggle switch component.
/// </summary>
public partial class ToggleInput
{
    #region Fields
    ...
    /// <summary>
    /// Attempts to parse a string value to a boolean for the toggle input.
    /// </summary>
