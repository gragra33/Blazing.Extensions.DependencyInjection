...
public class DataService : IDataService
{
    ...
    {
        new DataItem { Id = 1, Name = "Sample Item 1", Description = "First sample item", CreatedDate = DateTime.Now.AddDays(-5), IsActive = true },
        new DataItem { Id = 2, Name = "Sample Item 2", Description = "Second sample item", CreatedDate = DateTime.Now.AddDays(-3), IsActive = false },
        new DataItem { Id = 3, Name = "Sample Item 3", Description = "Third sample item", CreatedDate = DateTime.Now.AddDays(-1), IsActive = true },
    };
