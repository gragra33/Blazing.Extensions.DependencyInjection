# Contributing to Blazing.Extensions.DependencyInjection
...
Look for [issues marked with 'help wanted'](https://github.com/gragra33/Blazing.Extensions.DependencyInjection/issues?q=is%3Aissue+is%3Aopen+label%3A%22help+wanted%22) to find good places to start contributing.
...
## Report bugs using Github's [issues](https://github.com/gragra33/Blazing.Extensions.DependencyInjection/issues)

We use GitHub issues to track public bugs. Report a bug by [opening a new issue](https://github.com/gragra33/Blazing.Extensions.DependencyInjection/issues/new/choose); it's that easy!
